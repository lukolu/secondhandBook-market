    ...
    <script>
        $(function () {
            $("button.addToCart").click(function () {
                ...
                // location.href="http://localhost:8080/book_war_exploded/cartServlet?action=ajaxAddItem&id="+bookId;
                $.getJSON("http://localhost:8080/book_war_exploded/cartServlet","action=ajaxAddItem&id="+bookId,function (data) {
                    $("#addItemLast").text(data.lastAddItemName);
        ...
        <c:if test="${not empty sessionScope.user}">
            <div style="text-align: center">
                ...
                <c:if test="${not empty sessionScope.cart.items}">
                    ...
                    <div>
                        您刚刚将<span style="color: red" id="addItemLast">${sessionScope.lastAddItemName}</span>加入到了购物车中
                    </div>
                </c:if>
